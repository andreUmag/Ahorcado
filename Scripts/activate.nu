...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Andre\Documents\COMPILADORES\ahorcado'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Andre\Documents\COMPILADORES\ahorcado\Scripts\deactivate.nu'
